    ...
    return (
        <div className="card text-warning text-center rounded"  id="about">
            <div className="card-body">
                    ...
                    <h4 className="card-subtitle mb-2 text-light">AJ Huff is an ambitious Front End Developer with an interest in UX/UI design who hopes
                    to bring a creative
                    problem
                    ...
                    <br />
                    <h4 className="card-subtitle mb-2 text-light">AJ lives in San Francisco, California and is the author of the Medium blog, "Code Black Boy".</h4>
